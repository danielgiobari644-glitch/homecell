        ...
        row.innerHTML = `
          ...
          <div class="space-y-1 max-w-[85%]">
            <div class="flex items-center gap-2 ${isMe ? 'justify-end' : ''}">
              ...
              <!-- Fellowship Marker -->
              <span class="text-[10px] font-bold px-1.5 py-0.5 rounded-md bg-blue-50 dark:bg-[#131d3d] border border-transparent dark:border-blue-500/30 text-blue-600 dark:text-blue-300">${msg.fellowshipName || 'Home.cell'}</span>
